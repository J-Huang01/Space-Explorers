...
public final class SpaceExplorers implements IPlanetLookup {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        IStrategy strategy1 = new AI2Strategy();
        IStrategy strategy2 = new StudentStrategy();

        int player1Wins = 0;
        int player2Wins = 0;

        int howManyGames = 100;

        for(int i=0; i<howManyGames; i++){
            String graph = "graph_"+i;
            SpaceExplorers spaceExplorers = new SpaceExplorers(strategy1, strategy2, graph);
        ...
        System.out.println("Student Strategy won "+ player2Wins+" games out of " + howManyGames + " games. ");
    }
}
